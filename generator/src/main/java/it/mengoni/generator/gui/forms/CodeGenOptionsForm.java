...
public class CodeGenOptionsForm extends JPanel {
	/**
	 *
	 */
	...
	JTextField m_textRootOut = new JTextField();
	JTextField m_textPackage = new JTextField();
	JTextField m_textCatalog = new JTextField();
	JTextField m_textSchema = new JTextField();
	...
	public JPanel createNew_Form() {
		...
		TitledBorder titledborder1 = new TitledBorder(null, "Generazione Codice", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, new Color(49, 106, 196));
		...
		m_Test_Comp.setText("Output Dir:");
		m_New_Form.add(m_Test_Comp, cc.xy(2, 2));

		m_Test_Comp1.setName("Test Comp");
		m_Test_Comp1.setText("Java Package:");
		m_New_Form.add(m_Test_Comp1, cc.xy(2, 4));

		m_Test_Comp2.setName("Test Comp");
		m_Test_Comp2.setText("Db Catalog:");
		m_New_Form.add(m_Test_Comp2, cc.xy(2, 6));

		m_Test_Comp3.setName("Test Comp");
		m_Test_Comp3.setText("Db schema:");
		m_New_Form.add(m_Test_Comp3, cc.xy(2, 8));

		m_textRootOut.setName("textRootOut");
		m_New_Form.add(m_textRootOut, cc.xy(4, 2));

		m_textPackage.setName("textPackage");
		m_textPackage.setToolTipText("");
		m_New_Form.add(m_textPackage, cc.xy(4, 4));

		m_textCatalog.setName("textCatalog");
		m_New_Form.add(m_textCatalog, cc.xy(4, 6));

		m_textSchema.setName("textSchema");
		m_New_Form.add(m_textSchema, cc.xy(4, 8));
